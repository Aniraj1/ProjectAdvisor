...
urlpatterns = [
    path("create-checkout-session/",CreateCheckoutSessionView.as_view(),name="create-checkout-session-product"),
    path("", ProductLandingPageView.as_view(), name="Product_page"),
    path("get-all/",views.get_products,name="get-all-products"),
    path("get-all/<str:pk>/",views.get_product,name="get-product-pk"),
